function tarjeta_p(tid, titulo, Favorito, Rol) {
    ...
    <div class="card-body tarjeta-int d-flex flex-column p-3">
							<div class="d-flex flex-row">
								...
								<div class="material-symbols-outlined  ms-auto icono-favorito" ${color_a}="">
								...
								<div class="material-symbols-outlined ms-3 icono-eliminar">
									<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill=${Favorito?"yellow":"currentColor"} class="bi bi-trash2-fill" viewBox="0 0 16 16">
...
export function Cards_Home() {
    ...
    //Contendor
    root.className = 'row flex-row h-100';
    root.id = "Cards-Grid";
	...
	const add = (tid,titulo,Favorito,Rol) => {
		root.appendChild(tarjeta_p(tid,titulo,Favorito,Rol))
	}
	
	

    return{root,render,add}
